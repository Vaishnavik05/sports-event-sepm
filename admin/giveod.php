...
<head>
    ...
    <style>.container{max-width:1200px;margin:20px auto;padding:0 15px}.card{margin-bottom:20px;box-shadow:0 2px 5px rgba(0,0,0,0.1)}.verification-code{font-size:24px;font-weight:bold;color:#28a745;padding:10px;background-color:#f8f9fa;border-radius:5px;display:inline-block;margin:10px 0}.table-responsive{max-height:70vh;overflow-y:auto;overflow-x:auto;margin-bottom:15px}.badge{font-size:0.85em;margin-right:3px;margin-bottom:3px;display:inline-block}.table{width:100%;table-layout:fixed}.table th,.table td{white-space:normal;word-break:break-word;vertical-align:middle}.table-wrapper{position:relative}.table-wrapper .table thead{position:sticky;top:0;z-index:1;background-color:#fff}.btn{margin-right:5px;margin-bottom:5px}@media (max-width:768px){.verification-code{font-size:18px}.card-header{flex-direction:column;align-items:start}.verification-code{margin-top:10px}.table th,.table td{font-size:14px;padding:8px 5px}}</style>
</head>
<body>
    <div class="container">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="card mt-4">
                            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center flex-wrap">
                                <h5 class="mb-2 mb-md-0">Single Player Records for <?php echo $event_name; ?></h5>
                                <?php if ($active_code): ?>
                    ...
                    <form method="post" action="">
                        ...
                        <div class="card mt-4">
                            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center flex-wrap">
                                <h5 class="mb-2 mb-md-0">Group Player Records for <?php echo $event_name; ?></h5>
                                <?php if ($active_code): ?>
                                    <div class="verification-code">Code: <?php echo $active_code; ?></div>
                                    <input type="hidden" name="verification_code" value="<?php echo $active_code; ?>">
                                <?php endif; ?>
                    ...
                    <form method="post" action="">
                        ...
                        <div class="card mt-4">
                            <div class="card-header bg-info text-white d-flex justify-content-between align-items-center flex-wrap">
                                <h5 class="mb-2 mb-md-0">Volunteer Records for <?php echo $event_name; ?></h5>
                                <?php if ($active_code): ?>
                                    <div class="verification-code">Code: <?php echo $active_code; ?></div>
                                    <input type="hidden" name="verification_code" value="<?php echo $active_code; ?>">
                                <?php endif; ?>
